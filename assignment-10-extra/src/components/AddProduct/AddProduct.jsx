...
const AddProduct = () => {
  const handleAddProduct = (event) => {
    ...
    fetch("https://doploy-10-bqam80m6u-mahmudunnabis-projects.vercel.app/products", {
      method: "POST",
      headers: {
    ...
    <div className="bg-blue-300 w-[800px] mx-auto p-10">
      <div className="flex flex-col justify-center items-center mb-10">
        <h2 className="text-4xl font-bold text-center">
          Technology and Electronics <span className="text-blue-800">Data Collection</span>
        </h2>
        <p className="text-lg font-medium mt-3 w-[700px] text-center">
          Welcome to our Technology and Electronics Data Collection. We value your input and would like to learn more
      ...
      <form onSubmit={handleAddProduct}>
        ...
        <input type="submit" value="Add Product" className="btn btn-block bg-blue-800 text-white" />
      </form>
    </div>
  );
};
